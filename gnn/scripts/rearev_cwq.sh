# FOR WEBSQP
python3 main.py ReaRev --entity_dim 50 --num_epoch 200 --batch_size 8 --eval_every 10 --data_folder data/webqsp/ --lm sbert --num_iter 2 --num_ins 3 --num_gnn 3 --name webqsp --experiment_name webqsp
