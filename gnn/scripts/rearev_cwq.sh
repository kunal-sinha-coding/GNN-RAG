...
# --num_epoch 200
python3 main.py ReaRev --entity_dim 50 --num_epoch 2 --batch_size 1 --eval_every 1  \
 --lm relbert --num_iter 1 --num_ins 3 --num_gnn 3  --name cwq \
 --experiment_name prn_cwq-rearev-sbert --data_folder data/CWQ/ \
 --load_experiment prn_cwq-rearev-sbert-final.ckpt --warmup_epoch 1 #--num_epoch 100 --warmup_epoch 80
